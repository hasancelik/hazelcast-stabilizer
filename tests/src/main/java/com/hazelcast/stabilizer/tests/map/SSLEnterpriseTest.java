...
public class SSLEnterpriseTest {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        File configFile = new File("/home/hcelik/git/hazelcast-stabilizer/dist/src/main/dist/conf/hazelcast.xml");
        new TestRunner<SSLEnterpriseTest>(test).withHazelcastConfig(configFile).run();
    }
    ...
    public void verify() {
        ...
        for(String k: map.keySet()){
            ...
            assertEqualsByteArray(key, Arrays.copyOfRange(value, 0, 10));
        }
